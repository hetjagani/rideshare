...
INSERT INTO "auth"."user"(id, email, password, phone_number, is_verified) VALUES(2, 'testuser1@gmail.com', '$2a$10$BbwFEla6tO9cSiAXhaAePehLdeLJhlWsTMpa.Oti6qe96tKD3W.1q', '6692784685', true);
INSERT INTO "auth"."role"(user_id, role) VALUES(2, 'ADMIN');
INSERT INTO "auth"."role"(user_id, role) VALUES(2, 'DRIVER');
