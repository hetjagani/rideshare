...
public class Rating {
    ...
    public Rating(Integer id, UserInfo user, UserInfo ratingUser, Float rating, String description, List<String> liked, List<String> disliked) {
        this.id = id;
        this.user = user;
